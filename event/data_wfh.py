...
wfh_notify_problem1 = [ pygame.image.load(os.path.join("event/gov_img", "M1_A.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M1_B.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M1_C.png"))]
wfh_notify2_problem1 = [ pygame.image.load(os.path.join("event/gov_img", "M1_A2.png")),
...
wfh_impact_problem1 = [[10,0,3,1,3,1],[30,20,1,-1,2,0],[20,10,-1,-3,5,3]]
wfh_impact2_problem1 = [[10,0,3,1,3,1],[30,20,1,-1,2,0],[20,10,-1,-3,5,3]]
...
wfh_notify_problem2 = [ pygame.image.load(os.path.join("event/gov_img", "M2_A.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M2_B.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M2_C.png"))]
wfh_notify2_problem2 = [ pygame.image.load(os.path.join("event/gov_img", "M2_A2.png")),
...
wfh_text_problem2 = [pygame.image.load(os.path.join("event/wfh_img", "Q1_A.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_B.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_C.png"))]
...
wfh_impact_problem2 = [[20,10,-1,-3,5,3],[10,0,1,-1,2,0], [30,20,-1,-3,5,3]]
wfh_impact2_problem2 = [[20,10,-1,-3,5,3],[10,0,1,-1,2,0], [30,20,-1,-3,5,3]]
...
wfh_notify_problem3 = [ pygame.image.load(os.path.join("event/gov_img", "M3_A.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M3_B.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M3_C.png"))]
wfh_notify2_problem3 = [ pygame.image.load(os.path.join("event/gov_img", "M3_A2.png")),
...
wfh_text_problem3 = [pygame.image.load(os.path.join("event/wfh_img", "Q1_A.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_B.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_C.png"))]
...
wfh_impact_problem3 = [[20,10,1,-1,3,1],[10,0,-1,-3,2,0], [10,0,2,0,5,3]]
wfh_impact2_problem3 = [[20,10,1,-1,3,1],[10,0,-1,-3,2,0], [10,0,2,0,5,3]]
...
wfh_notify_problem4 = [ pygame.image.load(os.path.join("event/gov_img", "M4_A.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M4_B.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M4_C.png"))]
wfh_notify2_problem4 = [ pygame.image.load(os.path.join("event/gov_img", "M4_A2.png")),
...
wfh_text_problem4 = [pygame.image.load(os.path.join("event/wfh_img", "Q1_A.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_B.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_C.png"))]
...
wfh_impact_problem4 =[[10,0,3,1,3,1],[30,0,3,-3,5,0], [30,20,-1,-3,2,0]]
wfh_impact2_problem4 =[[10,0,3,1,3,1],[30,0,3,-3,5,0], [30,20,-1,-3,2,0]]
...
wfh_notify_problem5 = [ pygame.image.load(os.path.join("event/gov_img", "M5_A.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M5_B.png")),
                        pygame.image.load(os.path.join("event/gov_img", "M5_C.png"))]
wfh_notify2_problem5 = [ pygame.image.load(os.path.join("event/gov_img", "M5_A2.png")),
...
wfh_text_problem5 = [pygame.image.load(os.path.join("event/wfh_img", "Q1_A.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_B.png")),
                        pygame.image.load(os.path.join("event/wfh_img", "Q1_C.png"))]
...
wfh_impact_problem5 =[[10,0,1,-1,2,0],[30,20,-1,-3,2,0], [10,0,-1,-3,5,3]]
wfh_impact2_problem5 =[[10,0,1,-1,2,0],[30,20,-1,-3,2,0], [10,0,-1,-3,5,3]]

wfh_decision = [wfh_decision_problem1,wfh_decision_problem2,wfh_decision_problem3,wfh_decision_problem4,wfh_decision_problem5]
wfh_impact = [wfh_impact_problem1,wfh_impact_problem2,wfh_impact_problem3,wfh_impact_problem4,wfh_impact_problem5]
wfh_impact2 = [wfh_impact2_problem1,wfh_impact2_problem2,wfh_impact2_problem3,wfh_impact2_problem4,wfh_impact2_problem5]

wfh_hint = [wfh_hint_problem1,wfh_hint_problem2,wfh_hint_problem3,wfh_hint_problem4,wfh_hint_problem5]
wfh_notify = [wfh_notify_problem1,wfh_notify_problem2,wfh_notify_problem3,wfh_notify_problem4,wfh_notify_problem5]
wfh_notify2 = [wfh_notify2_problem1,wfh_notify2_problem2,wfh_notify2_problem3,wfh_notify2_problem4,wfh_notify2_problem5]
wfh_text = [wfh_text_problem1,wfh_text_problem2,wfh_text_problem3,wfh_text_problem4,wfh_text_problem5]
wfh_message1 = [wfh_message1_problem1,wfh_message1_problem2,wfh_message1_problem3,wfh_message1_problem4,wfh_message1_problem5]
wfh_message2 = [wfh_message2_problem1,wfh_message2_problem2,wfh_message2_problem3,wfh_message2_problem4,wfh_message2_problem5]
