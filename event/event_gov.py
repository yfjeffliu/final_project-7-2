...
def set_gov(num:int):
    ...
    event_decision = [an_decision(1,event_select_img[0],event_impact[0],event_notify[0],event_hint[0],event_impact2[0],event_notify2[0],event_text[0],event_message1[0],event_message2[0]),
                      an_decision(2,event_select_img[1],event_impact[1],event_notify[1],event_hint[1],event_impact2[1],event_notify2[1],event_text[1],event_message1[1],event_message2[1]),
                      an_decision(3,event_select_img[2],event_impact[2],event_notify[2],event_hint[2],event_impact2[2],event_notify2[2],event_text[2],event_message1[2],event_message2[2])]
